...
const DOMAIN_ORDER = ['light','switch','input_boolean','climate','lock','media_player','cover','fan','script','scene'];
const DOMAIN_LABELS = {
  light: 'Lights', switch: 'Switches', input_boolean: 'Switches', climate: 'Climate',
  lock: 'Locks', media_player: 'Media', cover: 'Covers', fan: 'Fans', script: 'Scripts', scene: 'Scenes',
};
const DOMAIN_ICONS = {
  light: 'lightbulb', switch: 'toggle_on', input_boolean: 'toggle_on', climate: 'thermostat',
  lock: 'lock', media_player: 'speaker', cover: 'blinds', fan: 'mode_fan', script: 'play_circle', scene: 'palette',
};
const DOMAIN_COLORS = {
  ...
  scene: { bg: 'bg-fuchsia-500/10', text: 'text-fuchsia-500', icon: 'bg-fuchsia-500' },
};
